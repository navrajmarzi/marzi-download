...
const PAGE_CONTENT = DESTINATIONS_CONTENT.BALI;

export const metadata: Metadata = {
  title: "Marzi Mitr — Planning a Bali trip?",
  description:
...
export default function TravelBaliPage() {
  return (
    <div className="min-h-screen bg-white">
      <Script id="meta-pixel-tas-bali" strategy="afterInteractive">
