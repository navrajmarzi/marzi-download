...
const PAGE_CONTENT = DESTINATIONS_CONTENT.VIETNAM;

export const metadata: Metadata = {
  title: "Marzi Mitr — Planning a Vietnam trip?",
  description:
...
export default function TravelVietnamPage() {
  return (
    <div className="min-h-screen bg-white">
      <Script id="meta-pixel-tas-vietnam" strategy="afterInteractive">
