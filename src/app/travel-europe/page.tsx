...
const PAGE_CONTENT = DESTINATIONS_CONTENT.EUROPE;

export const metadata: Metadata = {
  title: "Marzi Mitr — Planning a Europe trip?",
  description:
...
export default function TravelEuropePage() {
  return (
    <div className="min-h-screen bg-white">
      <Script id="meta-pixel-tas-europe" strategy="afterInteractive">
